...
#define OP_MODE_WRITE_FRAME_SIZE				1
#define DATE_AND_TIME_WRITE_FRAME_SIZE			6
#define ALARMS_STATUS_WRITE_FRAME_SIZE			1
...
#define MOTOR_SPEED_STATUS_WRITE_FRAME_SIZE		2
#define CURRENT_STATUS_WRITE_FRAME_SIZE			4
#define BATTERY_LEVEL_WRITE_FRAME_SIZE			1
...
#define PARAM_STATUS_READ_FRAME_SIZE			2
#define OP_MODE_READ_FRAME_SIZE					1
#define DATE_AND_TIME_READ_FRAME_SIZE			6
...
/* Buffers' size */
#define SPI_TX_BUFF_SIZE						6
#define SPI_RX_BUFF_SIZE						6
