...
#define DISPLAY_PERIOD_N_OPTIONS					3
#define WORKING_COUNT_DISPLAY_PERIOD_01_IN_HOURS	12
#define WORKING_COUNT_DISPLAY_PERIOD_02_IN_HOURS	6
#define WORKING_COUNT_DISPLAY_PERIOD_03_IN_HOURS	3		
